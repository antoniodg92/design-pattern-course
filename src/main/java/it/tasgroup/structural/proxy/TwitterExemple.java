...
//
//public class TwitterExample { Add Tweeter api twitter4j-core-4.0.4.jar to the referenced library
//
//    private static final String TWITTER_CONSUMER_KEY = "NcoaBPbSKxkCJhbDyqzjQKVjr";       //queste vanno create e prese da htttps://dev.tweeter.com -> Manage your apps menu -> create new app.
